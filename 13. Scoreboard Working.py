...
background = r'H:\Python\images\wood2.jpg'
red_card = r'H:\Python\images\cards\red_back.png'
black_card = r'H:\Python\images\cards\card_cover.png'
...
def main_menu():
    ...
    # menu.add_image(red_card, angle=0, image_id='', scale=(0.25, 0.25), scale_smooth=False, selectable=False)
...
def calculate_score():
    ...
    while o != 3:
        while u < len(player_hand[o]):
            ...
            # if current_card.value == "2":
            #     player_score[player] += 5
            #     print(current_card.value)
            #     pass
            # if current_card.value == "3":
            #     player_score[player] += 5
            #     print(current_card.value)
            #     pass
            # if current_card.value == "4":
            #     player_score[player] += 5
            #     print(current_card.value)
            #     pass
            # if current_card.value == "5":
            #     player_score[player] += 5
            #     print(current_card.value)
            #     pass
            # if current_card.value == "6":
            #     player_score[player] += 5
            #     print(current_card.value)
            #     pass
            # if current_card.value == "7":
            #     player_score[player] += 5
            #     print(current_card.value)
            #     pass
...
def next_round():
    global notOver, player1_hand_put_down, player2_hand_put_down, player3_hand_put_down, deck, suit, card, rows, \
        cols, player_hand, current_card, player_may_i, round_counter, confirm_put_down, confirm_player_put_down, discard_pile
    notOver = False
    player1_hand_put_down = [[], [], []]
    ...
    calculate_score()  # reinitialize for testing of score calculator

    if round_counter == 7:
        pygame.quit()

    else:
        put_down_button[0] = (button(grey, 1625, 700, 80, 30, round_type[round_counter - 1][0]))
        put_down_button[1] = (button(grey, 1625, 745, 80, 30, round_type[round_counter - 1][1]))
        put_down_button[2] = (button(grey, 1625, 790, 80, 30, round_type[round_counter - 1][2]))
