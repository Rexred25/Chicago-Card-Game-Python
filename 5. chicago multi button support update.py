...
swap_card_button = button((0, 255, 0), 1625, 675, 275, 50, "Pick Discard Card")
...
def build_multi_button():
    ...
    # for temp_y in range(len(player_hand[player])):
    while temp_y < 18:
        multi_use_button.append(button((0, 255, 0), swap_x_coord, 1025, 40, 40, swap_button_number.__str__()))
        swap_x_coord += 100
        swap_button_number += 1
        temp_y += 1
        # print(swap_x_coord)
