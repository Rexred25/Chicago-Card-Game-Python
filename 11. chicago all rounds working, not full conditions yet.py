...
def next_round():
    global notOver, player1_hand_put_down, player2_hand_put_down, player3_hand_put_down, deck, suit, card, rows, cols, player_hand, current_card, player_may_i, round_counter, confirm_put_down, confirm_player_put_down
    notOver = False
    player1_hand_put_down = [[], [], []]
