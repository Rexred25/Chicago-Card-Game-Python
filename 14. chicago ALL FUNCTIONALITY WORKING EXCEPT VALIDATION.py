...
while not notOver:
    ...
    while True:
        ...
        # if draw_card_button.color == (255, 0, 0) and disc is False or (len(player_hand[player])) == 1:
        #     discard_button.color = grey
        ...
        # if put_down_button.color == (255, 0, 0) or put_down_button.color == (0, 0, 255):
        ...
        255, 0, 0):  # runs only if put down button is clicked
            ...
            # u = 0
            # while u != 3:
            #     if append_player_choice_button[u].color == (255, 0, 0):
            #         for i in range(len(put_down_type_button)):
