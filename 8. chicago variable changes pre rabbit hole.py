...
put_down_button = [None, None, None]
...
def assign_global_vars():
    ...
    global p
    global potato1
    global run_build_swap
    global notOver

    global player1_put_down
    global player2_put_down
    global player3_put_down

    global swap_x_coord
    global swap_button_number

    global player1_hand_put_down
    global player2_hand_put_down
    global player3_hand_put_down
    global player_hand_put_down
    global build_set
    global put_down_array_counter
    global confirm_player_put_down
    ...
    global player_x_coords
    global player_y_coords

    global confirm_put_down

    global put_down_button
    global validate_card_down_button
...
put_down_button[0] = (button(grey, 1625, 700, 80, 30, round_type[0][0]))
put_down_button[1] = (button(grey, 1625, 745, 80, 30, round_type[0][1]))
put_down_button[2] = (button(grey, 1625, 790, 80, 30, round_type[0][2]))
