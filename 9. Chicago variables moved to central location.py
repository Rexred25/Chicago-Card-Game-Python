...
def multi_button_function():
    ...
    if swap_bool == True:
        ...
        while h < player_card_range:
            if multi_use_button[h].isOver(pos):
                multi_use_button[h].color = (255, 0, 0)
                if swap_card[0] is None and player_hand[player][h] is not None and multi_use_button[h].color == (255, 0, 0):
                    swap_card[0] = h
                    multi_use_button[h].color = (255, 0, 0)
                ...
                if (swap_card[0] or swap_card[0] == 0) and swap_card[1] is not None and multi_use_button[h].color == (255, 0, 0):
                    # print("hi")
...
def next_round():
    global notOver, player1_hand_put_down, player2_hand_put_down, player3_hand_put_down
    notOver = False
    player1_hand_put_down = [[], [], []]
